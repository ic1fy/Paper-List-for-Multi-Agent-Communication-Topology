...
- [[2026-arXiv]](https://arxiv.org/abs/2609.02122) **AI agents reshape consensus formation in human groups** [PDF](https://arxiv.org/pdf/2609.02122v1) [🐙 Code / Data（分析代码与处理后数据）](https://github.com/tsinghua-fib-lab/human-ai-consensus)
  - 简介：论文检验 AI 作为普通群体成员参与交流时，会怎样改变共识强度与内容。每组固定 24 个真人及智能体席位，连续 40 轮随机两两配对，独立用一句英文描述同一七巧板图形，提交后看到对方描述及语义相似度得分；主实验采用 Qwen2.5-VL-32B-Instruct，比较 0%、12.5%、33.3%、50%、75% 的 AI 比例，并用末轮描述的平均语义相似度衡量共识。 **主要结论：** 相比纯真人，12.5% AI 使共识强度增加约 8.0%，33.3% 与 50% 分别降低约 23.1% 和 14.5%；75% 时共识恢复，但表达更偏向 AI 的几何分解描述，真人对最终描述的认同反而较低。固定 33.3% 比例时，提示 AI 更坚持己见会进一步降低共识、增加其概念影响。因此，需要区分“表达趋同”与“人类认同”，不能以 AI 越多或共识越强推断协作越好。实验采用单一图形、每条件一组及同一模型家族，比例拐点尚不能推广为普遍规律；通信采用随机配对，并未学习最优拓扑。

  [![human-ai-consensus：原论文 Figure 1](https://arxiv.org/html/2609.02122v1/fig1.png)](https://arxiv.org/abs/2609.02122)
